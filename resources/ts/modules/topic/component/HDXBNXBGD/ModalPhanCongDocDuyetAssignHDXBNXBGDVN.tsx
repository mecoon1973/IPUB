...
import { HDXBNXBGDVN_LOC_THEO } from "../../constants/hdxbNxbgdvn";

interface ModalPhanCongDocDuyetAssignHDXBNXBGDVNProps {
    listBTV: User[];
    onSuccess?: () => void;
}

function ModalPhanCongDocDuyetAssignHDXBNXBGDVN(props: ModalPhanCongDocDuyetAssignHDXBNXBGDVNProps) {
    ...
    useEffect(() => {
        ...
        HDXBNXBGDVNApi.getList({ PhanCong: HDXBNXBGDVN_LOC_THEO.CHUA_PHAN_CONG }).then((res) => setDeTaiChuaPhanCong(res));
    }, [open]);
...
export default React.memo(ModalPhanCongDocDuyetAssignHDXBNXBGDVN);
