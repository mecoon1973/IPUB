...
class FrmSearchDoituongSNVRequest extends FormRequest
{
    protected $casts = [
        "IsDeleted" => "boolean",
        "TenDonVi" => "string",
    ...
    /**
     * Chuyển đổi dữ liệu đầu vào thành đối tượng FilterDoituongSNV.
     *
     * @return FilterDoituongSNV
     */
    public function toFilter() : FilterDoituongSNV {
        $validated = $this->validated();
        $filter = new FilterDoituongSNV();
