...
class FrmSearchCongviecthietkeRequest extends FormRequest
{
    protected $casts = [
        "IsDeleted" => "boolean",
    ];
    ...
    /**
     * Chuyển đổi dữ liệu đầu vào thành đối tượng FilterCongviecthietke.
     *
     * @return FilterCongviecthietke
     */

    public function toFilter() : FilterCongviecthietke {

        $validated = $this->validated();
        $filter = new FilterCongviecthietke();
