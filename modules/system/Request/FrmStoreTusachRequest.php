...
class FrmStoreTusachRequest extends FormRequest
{
    protected $casts = [
        'id' => 'int',
        'MaTuSach' => 'string',
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'MaTuSach' => 'required|string|max:255',
            'TenTuSach' => 'required|string|max:2000',
    ...
    {
        return [
            'MaTuSach.required' => config('label.INPUT_ERROR', 'Dữ liệu không hợp lệ'),
            'TenTuSach.required' => config('label.INPUT_ERROR', 'Dữ liệu không hợp lệ'),
