...
class FrmSearchNgoainguRequest extends FormRequest
{
    protected $casts = [
        "IsDeleted" => "boolean",
        "IsUsed" => "boolean",
    ...
    /**
     * Chuyển đổi dữ liệu đầu vào thành đối tượng FilterNgoaingu.
     * @return FilterNgoaingu
     */

    public function toFilter() : FilterNgoaingu {

        $validated = $this->validated();
        $filter = new FilterNgoaingu();
