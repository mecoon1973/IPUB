...
class FrmSearchTusachRequest extends FormRequest
{
    protected $casts = [
        "IsDeleted" => "boolean",
    ];
    ...
    /**
     * Chuyển đổi dữ liệu đầu vào thành đối tượng FilterTusach.
     *
     * @return FilterTusach
     */

    public function toFilter() : FilterTusach {

        $validated = $this->validated();
        $filter = new FilterTusach();
