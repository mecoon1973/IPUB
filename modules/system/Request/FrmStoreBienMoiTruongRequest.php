...
class FrmStoreBienMoiTruongRequest extends FormRequest
{
    protected $casts = [
        'id' => 'int',
        'ConfigName' => 'string',
    ...
    {
        return [
            'ConfigName.required' => config('label.INPUT_ERROR', 'Dữ liệu không hợp lệ'),
            'ConfigNotes.required' => config('label.INPUT_ERROR', 'Dữ liệu không hợp lệ'),
            'ConfigValue.required' => config('label.INPUT_ERROR', 'Dữ liệu không hợp lệ'),
