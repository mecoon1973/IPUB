...
class FrmSearchDoituongRequest extends FormRequest
{
    protected $casts = [
        "IsDeleted" => "boolean",
    ];
    ...
    /**
     * Chuyển đổi dữ liệu đầu vào thành đối tượng FilterDoituong.
     *
     * @return FilterDoituong
     */

    public function toFilter() : FilterDoituong {

        $validated = $this->validated();
        $filter = new FilterDoituong();
