...
class FrmSearchChucvuRequest extends FormRequest
{
    protected $casts = [
        "IsDeleted" => "boolean",
    ];
    ...
    /**
     * Chuyển đổi dữ liệu đầu vào thành đối tượng FilterChucvu.
     *
     * @return FilterChucvu
     */

    public function toFilter() : FilterChucvu {

        $validated = $this->validated();
        $filter = new FilterChucvu();
