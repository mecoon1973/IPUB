...
class FrmSearchChuyenMonRequest extends FormRequest
{
    protected $casts = [
        "IsDeleted" => "boolean",
    ];
    ...
    /**
     * Chuyển đổi dữ liệu đầu vào thành đối tượng FilterChuyenmon.
     *
     * @return FilterChuyenmon
     */

    public function toFilter() : FilterChuyenmon {

        $validated = $this->validated();
        $filter = new FilterChuyenmon();
