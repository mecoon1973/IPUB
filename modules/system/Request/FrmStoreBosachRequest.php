...
class FrmStoreBosachRequest extends FormRequest
{
    protected $casts = [
        'id' => 'int',
        'MaBo' => 'string',
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'MaBo' => 'required|string|max:255',
            'TenBo' => 'required|string|max:2000',
    ...
    {
        return [
            'MaBo.required' => config('label.INPUT_ERROR', 'Dữ liệu không hợp lệ'),
            'TenBo.required' => config('label.INPUT_ERROR', 'Dữ liệu không hợp lệ'),
