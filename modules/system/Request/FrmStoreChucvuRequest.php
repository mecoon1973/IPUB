...
class FrmStoreChucvuRequest extends FormRequest
{
    protected $casts = [
        'id' => 'int',
        'MaChucVu' => 'string',
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'TenChucVu' => 'required|string|max:2000',
    ...
    {
        return [
            'MaChucVu.required' => config('label.INPUT_ERROR', 'Dữ liệu không hợp lệ'),
            'TenChucVu.required' => config('label.INPUT_ERROR', 'Dữ liệu không hợp lệ'),
