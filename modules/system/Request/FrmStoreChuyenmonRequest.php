...
class FrmStoreChuyenmonRequest extends FormRequest
{
    protected $casts = [
        'id' => 'int',
        'TenChuyenMon' => 'string',
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'TenChuyenMon' => 'required|string|max:2000',
    ...
    {
        return [
            'TenChuyenMon.required' => config('label.INPUT_ERROR', 'Dữ liệu không hợp lệ'),
